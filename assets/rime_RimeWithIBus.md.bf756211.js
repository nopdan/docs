import{_ as e,c as a,o as i,O as l}from"./chunks/framework.fe655854.js";const h=JSON.parse('{"title":"Packages for Linux Distributions","description":"","frontmatter":{},"headers":[],"relativePath":"rime/RimeWithIBus.md","filePath":"home.wiki/RimeWithIBus.md"}'),s={name:"rime/RimeWithIBus.md"},n=l(`<blockquote><p>Building and installing ibus-rime.</p></blockquote><h1 id="packages-for-linux-distributions" tabindex="-1">Packages for Linux Distributions <a class="header-anchor" href="#packages-for-linux-distributions" aria-label="Permalink to &quot;Packages for Linux Distributions&quot;">​</a></h1><h2 id="archlinux" tabindex="-1">Archlinux <a class="header-anchor" href="#archlinux" aria-label="Permalink to &quot;Archlinux&quot;">​</a></h2><pre><code>pacman -S ibus-rime
...
# 下文略……
</code></pre><h2 id="ibus-rime-on-centos-7" tabindex="-1">ibus-rime on Centos 7 <a class="header-anchor" href="#ibus-rime-on-centos-7" aria-label="Permalink to &quot;ibus-rime on Centos 7&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">yum install -y gcc gcc-c++ boost boost-devel cmake make cmake3</span></span>
<span class="line"><span style="color:#A6ACCD;">yum install glog glog-devel kyotocabinet kyotocabinet-devel marisa-devel yaml-cpp yaml-cpp-devel gtest gtest-devel libnotify zlib zlib-devel gflags gflags-devel leveldb leveldb-devel libnotify-devel ibus-devel</span></span>
<span class="line"><span style="color:#A6ACCD;">cd /usr/src</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"># install opencc</span></span>
<span class="line"><span style="color:#A6ACCD;">curl -L https://github.com/BYVoid/OpenCC/archive/ver.1.0.5.tar.gz | tar zx</span></span>
<span class="line"><span style="color:#A6ACCD;">cd OpenCC-ver.1.0.5/</span></span>
<span class="line"><span style="color:#A6ACCD;">make</span></span>
<span class="line"><span style="color:#A6ACCD;">make install</span></span>
<span class="line"><span style="color:#A6ACCD;">ln -s /usr/lib/libopencc.so /usr/lib64/libopencc.so</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">cd /usr/src</span></span>
<span class="line"><span style="color:#A6ACCD;">git clone --recursive https://github.com/rime/ibus-rime.git</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">cd /usr/src/ibus-rime</span></span>
<span class="line"><span style="color:#A6ACCD;"># 下文略，同前文給出的安裝步驟</span></span></code></pre></div>`,45),t=[n];function o(r,u,p,d,c,b){return i(),a("div",null,t)}const g=e(s,[["render",o]]);export{h as __pageData,g as default};
